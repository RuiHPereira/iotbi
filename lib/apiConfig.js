...
config.broker.servers.owm_v1={host:'orion.orion_net',port:'1026',https:false,broker:'Orion',ngsi:'v2'};
config.broker.servers.test_ld={host:'orion_ld.orionld.net',port:'2026',https:false,ngsi:'ldv1',broker:'OrionLD',
...
config.broker.servers['urn:ngsi-ld:test_ld']={host:'172.19.0.6',port:'9090',https:false,ngsi:'ldv1',broker:'Scorpio',
		ngsildContext:'http://context/ngsi-context.jsonld',
		jsonldContext:'http://context/json-context.jsonld'};
config.broker.servers['urn:ngsi-ld:tenant:default']={host:'stellio.stellio_net',port:'8080',https:false,ngsi:'ldv1',broker:'Stellio',
		ngsildContext:'http://context/ngsi-context.jsonld',
		jsonldContext:'http://context/json-context.jsonld'};
config.broker.servers['urn:ngsi-ld:tenant:test_ld']={host:'stellio.stellio_net',port:'8080',https:false,ngsi:'ldv1',broker:'Stellio',
                ngsildContext:'http://context/ngsi-context.jsonld',
                jsonldContext:'http://context/json-context.jsonld'};
config.broker.servers['urn:ngsi-ld:tenant:owm_ld']={host:'stellio.stellio_net',port:'8080',https:false,ngsi:'ldv1',broker:'Stellio',
                ngsildContext:'http://context/ngsi-context.jsonld',
                jsonldContext:'http://context/json-context.jsonld'};
...
config.quantumleap.servers.test_ld={host:'quantumleap.orionld_net',port:'8668',https:false};
